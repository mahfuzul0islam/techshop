    ...
    <main class="p-6">
        <div class="mt-14">
            <div class="border-b border-gray-200 dark:border-slate-500/70">
                <h1 class="text-base">Edit Roles In Permissions</h1>
            </div>
                        ...
                        <div class="md:col-span-2">
                            <div class="card">
                                <div class="card-header bg-light dark:bg-slate-600">
                                    <h5 class="text-base">Edit Roles In Permissions</h5>
                                </div>
                                                ...
                                                @foreach ($permission_group as $group)
                                                    <div class="col-3">
                                                        ...
                                                        <div class="mt-2 mb-2">
                                                            <div class="flex items-center">
                                                                <input type="checkbox"
                                                                    class="form-checkbox rounded-sm text-primary"{{ App\Models\User::roleHasPermission($role, $permissions) ? 'checked' : '' }}>
                                                                <label
                                                            ...
                                                            <div class="mt-2 mb-2">
                                                                <div class="flex items-center">
                                                                    <input type="checkbox" name="permission[]"
                                                                        ...
                                                                        class="form-checkbox rounded-sm text-primary"{{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }}>
                                                                    <label class="ms-2"
