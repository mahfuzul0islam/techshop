    ...
    <main class="p-6">
        <div class="mt-14">
            <div class="border-b border-gray-200 dark:border-slate-500/70">
                <h1 class="text-base">Edit Category</h1>
            </div>
                        ...
                        <div class="md:col-span-2">
                            <div class="card">
                                <div class="card-header bg-light dark:bg-slate-600">
                                    <h5 class="text-base">Edit Category</h5>
                                </div>

                                <div class="p-6">

                                    <form class="space-y-4" method='POST' action="{{ route('update.category',$category->id) }}"
                                        ...
                                        <div class="mt-2">
                                            <img src="{{(!empty($category->image)) ? url('upload/categoryimage/'.$category->image): url('upload/defaultcategory.png')}}"
