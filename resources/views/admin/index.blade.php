                    ...
                    <div class="-m-1.5 overflow-x-auto">
                        <div class="p-1.5 min-w-full inline-block align-middle">
                            <div class="overflow-hidden">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-500/30">
                                    <thead>
                                        <tr class="border-t border-b-2 border-gray-200 dark:border-slate-500/30">
                                            <th scope="col"
                                                class="px-4 py-3 whitespace-nowrap text-start font-bold dark:text-white">
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-slate-500/30">
                                        ...
                                        <tr
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap">chadengle@dummy.com</td>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap">stillnotdavid@dummy.com</td>
                                        ...
                                        <tr
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap">adhamdannaway@dummy.com</td>
